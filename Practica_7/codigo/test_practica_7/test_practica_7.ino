 ...
 * Define Constants
 ****************************************/
#define WIFISSID "MEGACABLE-D3A2" // Put your WifiSSID here
#define PASSWORD "EzsDQEtr" // Put your wifi password here
#define TOKEN "BBFF-oRy6zfAfimZZiypBGYdCdlGJhVp8Ml" // Put your Ubidots' TOKEN
#define MQTT_CLIENT_NAME "234567AbCde" // MQTT client Name, please enter your own 8-12 alphanumeric character ASCII string; 
